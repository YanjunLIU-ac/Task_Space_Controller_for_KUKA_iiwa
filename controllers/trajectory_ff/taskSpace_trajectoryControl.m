...
title({'End-effector Position Error'; 'of Trajectory Controller'});
savefig('results\3dof\trajff_cartpos_error.fig');
...
savefig('results\3dof\trajff_cartpos_path.fig');

plotJointFigures(3, T, U, "Joint Torque of Trajectory Controller", 'Torque[Nm]')
savefig('results\3dof\trajff_joint_torque.fig');
plotJointFigures(4, T, Q, "Joint Configuration of Trajectory Controller", 'Angle[rad]')
savefig('results\3dof\trajff_joint_config.fig');
plotJointFigures(5, T, QDOT, "Joint Velocity of Trajectory Controller", 'Velocity[rad/s]')
savefig('results\3dof\trajff_joint_vel.fig');
